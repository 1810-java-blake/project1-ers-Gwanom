...
export class Reimbursement extends PureComponent {
    state = {
        color: null,
        status: null,
    }
    ...
    render() {
        return (
            <tr>
                ...
                <td>${this.props.reimbursement.reimbursementAmount}</td>
                <td>{this.timeConverter(this.props.reimbursement.submitted)}</td>

                <td>{this.props.reimbursement.description}</td>

                <td className={this.state.color}> {this.state.status} </td>
                <td>
